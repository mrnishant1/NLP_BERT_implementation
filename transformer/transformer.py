...
class Transformer:
    def __init__(self,word_embeds:Tensor, n_heads:int = 8):
        ...
        self.lr = 0.01
        # self.model = MLP(n_inp=self.n, Layer_outs=[512,self.n],activation_fn='tanh')
        self.model = MLP(n_inp=self.n, Layer_outs=[512,1],activation_fn='tanh')
...
ce = Transformer(word_embeds).encoder()
ce
